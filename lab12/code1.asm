...
.data
consoleHandle    DWORD ?
xyInit COORD <59,12> ; 起始座標
xyBound COORD <80,25> ; 一個頁面最大的邊界
xyPos COORD <59,12> ; 現在的游標位置
main EQU start@0
.code
main PROC
